...
(function () {
  ...
  <div class="notice-section">
    ...
    <div class="notice-lang en">
      ...
      Welcome to Udaipur Wildlife Sanctuary.<br>
      Please follow all safety rules and maintain cleanliness.<br>
      Enjoy your visit 🌿
    </div>

    <hr>

    <div class="notice-lang hi">
      <strong>प्रिय पर्यटक,</strong><br>
      उदयपुर वन्यजीव अभ्यारण्य में आपका स्वागत है।<br>
      कृपया सभी सुरक्षा नियमों का पालन करें और स्वच्छता बनाए रखें।<br>
      आपकी यात्रा सुखद हो।
    </div>
  ...
  const popupNotice =
    localStorage.getItem("popupNotice") || defaultNotice;

  content.innerHTML = popupNotice;
  ...
  function closeModal() {
    ...
    // 🔥 session based (refresh pe nahi dikhega)
    sessionStorage.setItem("noticeSeen", "true");
  }

  // ================= SHOW ONLY FIRST TIME (PER TAB SESSION) =================
